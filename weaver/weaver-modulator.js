...
class WeaverModulator extends AudioWorkletProcessor {
    ...
    static get parameterDescriptors() {
        return [
            { name: 'frequency', automationRate: 'a-rate', minValue: 1, maxValue: 24000, defaultValue: 1515 },
        ];
    }
    ...
    process(inputs, outputs, parameters) {
        ...
        const wIn = parameters['frequency'];
...
//            const v = this.lowPassIn.apply(input[i]);
            ...
            this.oscIn.advance(wIn.length > 1 ? wIn[i] : wIn[0], sampleRate);
